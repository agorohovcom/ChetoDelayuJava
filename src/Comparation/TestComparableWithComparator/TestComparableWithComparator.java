package Comparation.TestComparableWithComparator;
 ...
 */
public class TestComparableWithComparator {
    public static void main(String[] args) {
        ...
        Collections.sort(list/*, new SalaryComparator()*/); // Можно добавлять компаратор по необходимости
